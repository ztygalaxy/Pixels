...
public class MyScrollView extends ScrollView implements OnTouchListener {
    ...
    public void loadMoreImages() {
        if (hasSDCard()) {
            ...
            if (startIndex < StaticData.getLists().size()) {
                Toast.makeText(getContext(), "(ง •_•)ง努力加载...", Toast.LENGTH_SHORT).show();
                if (endIndex > StaticData.getLists().size()) {
                    endIndex = StaticData.getLists().size();
                }
    ...
    class LoadImageTask extends AsyncTask<Integer, Void, Bitmap> {
        ...
        protected Bitmap doInBackground(Integer... params) {
            ...
            mImageUrl = StaticData.getLists().get(mItemPosition).getsURL();
